...
const [selectedPositionTitle, setSelectedPositionTitle] = useState("");
    ...
    const handleScheduleInterview = async () => {
        ...
        try {
            const response = await fetch("http://docs.sentrifugo.com:8080/candidate/api/candidates/schedule-interview", {
                method: "PUT",
                headers: {
    ...
    const handleOffer = async () => {
        ...
        try {
            ...
            const response = await fetch('http://docs.sentrifugo.com:8080/candidate/api/candidates/offer', {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
